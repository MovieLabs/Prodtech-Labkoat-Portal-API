...
import { oktaSetup } from './src/controllers/oktaInterface.js';
// const { opaSetup } = require('./src/routes/opa-router');
// import { omcSetup } from './src/routes/omc-router.js';
import { vocabSetup } from './src/routes/vocab-router.js';
import { serviceSetup } from './src/helpers/serviceToken.js';
import { yamduSetup as yamduSetupOld } from './src/controllers/approval/yamduController.js';
import { yamduSetup } from './src/controllers/approval/hpaApproval/yamduFetch.js';
...
async function setupSecrets() {
    ...
    await yamduSetupOld(awsSecrets);
